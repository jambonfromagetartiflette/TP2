...
public class InternetFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Button btn = view.findViewById(R.id.internet_status_btn);
    ...
    public void onClick(View v) {
        final TextView txt = view.findViewById(R.id.internet_status_text);
        final ConnectivityManager mConnectivityManager = (ConnectivityManager) getActivity().getSystemService(Context.CONNECTIVITY_SERVICE);
        final GradientDrawable img = (GradientDrawable) view.findViewById(R.id.internet_shape).getBackground();

        if (mConnectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED) {
            txt.setText("WIFI");
            img.setColor(getResources().getColor(R.color.colorGreen));
        }
            ...
            txt.setText("Aucune connexion");
            img.setColor(getResources().getColor(R.color.colorRed));
        }
    }
